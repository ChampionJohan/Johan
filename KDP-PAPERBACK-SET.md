...
**앞서 03을 $8.99로 적었던 것을 $9.99로 고칩니다.** 아마존닷컴 종이책은
**$9.99 이상일 때만 60%**이고 그 아래는 50%입니다. $8.99는 50% 구간이라
1달러를 깎는 대가로 인세가 1.49달러 줄어듭니다.

인세는 **정가 × 비율 − 인쇄비**입니다. 자세한 계산은
[KDP-PAPERBACK-PRICING](KDP-PAPERBACK-PRICING.md) 에 있습니다.
