...
/* ═══ 11 테일러스 학비·경로 ═══ */
{
  ...
  note('표를 RM 기준으로 통일했습니다. 약학 학비는 학교 요금표에서 받아 채워 넣으십시오. 공대·약대 지망자는 5년 행을 보여 주는 것이 정확합니다.');
}
...
/* ═══ 13 선웨이 학비·경로 ═══ */
{
  ...
  bottom('환율 RM 1 ≈ 339원 기준 · 경영계열은 학교가 달러로 표기한 금액을 환산한 값입니다 ·  2025년 7월부터 외국인 학비에 6% 서비스세(SST)가 별도 부과됩니다');
  note('선웨이 경영계열만 학교가 달러로 표기합니다. 환산값임을 밝혀 두었습니다. 공대 지망자는 5년 행이 실제 예산입니다.');
}
