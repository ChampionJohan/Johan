...
/* ── 1. 표지 ── */
{
  ...
  [['RM 1 ≈ 339원','환율 기준'],['+6%','외국인 서비스세'],['5년','공학·약학 실제 기간']].forEach((c,i)=>{
...
/* ── 3. 테일러스 학비 ── */
{
  ...
  bottom('환율 RM 1 ≈ 339원 기준 · 6% 서비스세 별도 · 약학 학비는 학교 요금표에서 확인해 기입하십시오');
  note('약학 칸은 비워 두었습니다. 학교에서 받으면 그 숫자만 채우시면 됩니다.');
}
...
/* ── 8. 확인 항목 ── */
{
  ...
  const items = [
    ['테일러스 약학 학비','공식 Fees Schedule에서 4년 총액 확인'],
