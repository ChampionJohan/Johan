...
"""Loop Chronicles series — bundle 48-chapter manuscripts into PDF + EPUB.
    ...
    python3 tools/build_ebook.py both7 # Book 7, both languages
...
ROOT7 = "/home/user/Johan/writing/novel/마지막-방"
...
CONFIGS = {
    ...
    "ko5": dict(
        ...
        lang="ko",
        title="마른 골짜기",
        subtitle="루프 연대기 5권 · 에스겔 37장 3절에서 시작하는 이야기",
        author=AUTHOR_PLACEHOLDER_KO,
        toc_label="목차",
        cover_kicker="장편 소설",
        out_base="the-dry-valley-ko",
        part_word="부",
    ),
    "en5": dict(
        src_dir=os.path.join(ROOT5, "english"),
        out_dir=OUT5,
        pattern=re.compile(r"^\d{2}-.*\.md$"),
        lang="en",
        title="The Dry Valley",
        subtitle="Loop Chronicles Book 5 \u00b7 A novel that begins at Ezekiel 37:3",
        author=AUTHOR_PLACEHOLDER_EN,
        toc_label="Table of Contents",
        cover_kicker="A NOVEL",
    ...
    "ko7": dict(
        ...
        lang="ko",
        title="마지막 방",
        subtitle="루프 연대기 7권 · 다니엘 12장 4절에서 시작하는 이야기",
        author=AUTHOR_PLACEHOLDER_KO,
        toc_label="목차",
        cover_kicker="장편 소설",
        out_base="the-last-room-ko",
        part_word="부",
    ),
    "en7": dict(
        src_dir=os.path.join(ROOT7, "english"),
        out_dir=OUT7,
        pattern=re.compile(r"^\d{2}-.*\.md$"),
        lang="en",
        title="The Last Room",
        subtitle="Loop Chronicles Book 7 \u00b7 A novel that begins at Daniel 12:4",
        author=AUTHOR_PLACEHOLDER_EN,
        toc_label="Table of Contents",
        cover_kicker="A NOVEL",
        out_base="the-last-room-en",
        part_word="Part",
    ),
}
