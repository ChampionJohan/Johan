...
<!-- 목표 900~1,100자 = 3분. 위 [0:50] 배경 + [2:30] 해부 를 압축한다.
     해자·균열·적용은 뺀다. 새로 쓰지 말고 롱폼 문장을 줄여서 옮길 것. -->

### [0:00] 훅

<!-- TODO: 롱폼 훅을 그대로 써도 된다. -->

### [0:15] 배경

<!-- TODO: 롱폼 [0:50] 을 3분의 1로. -->

### [1:00] 해부

<!-- TODO: 롱폼 [2:30] 의 고객·가치·과금. 여기가 중폼의 본체다. -->

### [2:40] 마무리

<!-- TODO: "왜 안 뺏기는지는 롱폼에서" 로 닫는다. 일요일 본편으로 넘긴다. -->
